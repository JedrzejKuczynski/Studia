...
cat("Wartosc minimalna: ", min(dane_obl))
cat("Wartosc maksymalna: ", max(dane_obl))
cat("Kwantyle: ", quantile(dane_obl))
cat("Mediana", median(dane_obl))
cat("Srednia arytmetyczna: ", mean(dane_obl))
