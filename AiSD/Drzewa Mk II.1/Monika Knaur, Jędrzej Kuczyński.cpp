...
void bst_drzewo(bst_wezel *wezel, int tab[]){
    ...
    if(korzen == NULL){
        ...
        if(wezel->left != NULL){
            ...
            nowy->right = NULL;
            nowy->parent = wezel;
            nowy->wysokosc = nowy->parent->wysokosc + 1;
            wezel->left = nowy;
...
void wyswietl_wysokosc(bst_wezel *wezel){

    if(wezel != NULL){
        wyswietl_wysokosc(wezel->left);
        cout << setw(3) << wezel->wartosc << " " <<  setw(3) << wezel->wysokosc << endl;
        wyswietl_wysokosc(wezel->right);
    }
}
    ...
    while(1){
        ...
        switch(menu){
            ...
            case 1:
                ...
                cout << endl << "W" << "\t" << "Wys" << endl << endl;
                wyswietl_wysokosc(korzen);
                break;
            ...
            case 3:
                ...
                cout << endl; << "W" << "\t" << "Wysokosc wierzcholka" << endl << endl;
                wyswietl_wysokosc(korzenol);
                break;
